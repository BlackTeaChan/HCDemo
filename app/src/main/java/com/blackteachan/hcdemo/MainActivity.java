package com.blackteachan.hcdemo;
...
import com.blackteachan.hcdemo.ui.Ble_Activity;
...
public class MainActivity extends Activity implements OnClickListener, EasyPermissions.PermissionCallbacks {
    ...
    private void requestPermissions(){
        ...
        if(EasyPermissions.hasPermissions(this, permissions)){
            ...
            EasyPermissions.requestPermissions(this, "APP需要蓝牙权限", 0, permissions);
        }
    }
